(() => {
        ...
        <section class="login-card glass loading-card">
          ...
          ${showActions ? `
            <div class="bootstrap-actions">
              ...
              <a class="btn btn-secondary" href="diagnostico.html?v=20260817.21">Abrir diagnóstico</a>
              <a class="auth-link" href="limpiar-cache.html?v=20260817.21">Limpiar versión anterior</a>
  ...
  async function start() {
    ...
    try {
      ...
      await loadScript('calendario-premium.js?v=20260817.21');
      setTimeout(() => {
