const CACHE = 'academia-ag-v20260817.7';
const STATIC_ASSETS = [
  './',
  './index.html',
  './academia.html',
  './404.html',
  './styles.css?v=20260817.7',
  './app.js?v=20260817.7',
  './bootstrap.js?v=20260817.7',
  './lesson-experience.js?v=20260817.7',
  './quiz-randomizer.js?v=20260817.7',
  './course-structure.js?v=20260817.7',
  './supabase-config.js?v=20260817.7',
  './manifest.json',
  './diagnostico.html',
  './limpiar-cache.html',
