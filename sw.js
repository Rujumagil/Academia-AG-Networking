const CACHE = 'academia-ag-v20260817.10';
const STATIC_ASSETS = [
  './',
  './index.html',
  './academia.html',
  './404.html',
  './styles.css?v=20260817.10',
  './premium-learning.css?v=20260817.10',
  './app.js?v=20260817.10',
  './bootstrap.js?v=20260817.10',
  './lesson-experience.js?v=20260817.10',
  './video-fix.js?v=20260817.10',
  './quiz-randomizer.js?v=20260817.10',
  './course-structure.js?v=20260817.10',
  './premium-learning.js?v=20260817.10',
  './supabase-config.js?v=20260817.10',
  './manifest.json',
  './diagnostico.html',
  './limpiar-cache.html',
