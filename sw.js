const CACHE = 'academia-ag-v20260817.9';
const STATIC_ASSETS = [
  './',
  './index.html',
  './academia.html',
  './404.html',
  './styles.css?v=20260817.9',
  './app.js?v=20260817.9',
  './bootstrap.js?v=20260817.9',
  './lesson-experience.js?v=20260817.9',
  './video-fix.js?v=20260817.9',
  './quiz-randomizer.js?v=20260817.9',
  './course-structure.js?v=20260817.9',
  './supabase-config.js?v=20260817.9',
  './manifest.json',
  './diagnostico.html',
  './limpiar-cache.html',
