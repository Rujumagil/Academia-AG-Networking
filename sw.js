const CACHE = 'academia-ag-v20260817.11';
const STATIC_ASSETS = [
  './',
  './index.html',
  './academia.html',
  './404.html',
  './styles.css?v=20260817.11',
  './premium-learning.css?v=20260817.11',
  './app.js?v=20260817.11',
  './bootstrap.js?v=20260817.11',
  './lesson-experience.js?v=20260817.11',
  './video-fix.js?v=20260817.11',
  './quiz-randomizer.js?v=20260817.11',
  './course-structure.js?v=20260817.11',
  './premium-learning.js?v=20260817.11',
  './lesson-cleanup.js?v=20260817.11',
  './supabase-config.js?v=20260817.11',
  './manifest.json',
  './diagnostico.html',
  './limpiar-cache.html',
