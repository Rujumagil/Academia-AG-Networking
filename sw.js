const CACHE = 'academia-ag-v20260817.8';
const STATIC_ASSETS = [
  './',
  './index.html',
  './academia.html',
  './404.html',
  './styles.css?v=20260817.8',
  './app.js?v=20260817.8',
  './bootstrap.js?v=20260817.8',
  './lesson-experience.js?v=20260817.8',
  './video-fix.js?v=20260817.8',
  './quiz-randomizer.js?v=20260817.8',
  './course-structure.js?v=20260817.8',
  './supabase-config.js?v=20260817.8',
  './manifest.json',
  './diagnostico.html',
  './limpiar-cache.html',
