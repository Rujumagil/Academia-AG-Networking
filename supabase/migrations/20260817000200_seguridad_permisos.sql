...
-- Migración productiva: no asigna un administrador por correo de forma automática.
...
-- Función segura para que únicamente un administrador activo pueda cambiar roles.
...
-- No se concede a anon ni authenticated. Se ejecuta de forma explícita desde SQL Editor
-- cuando ya exista el usuario que será administrador principal.
